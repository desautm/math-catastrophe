...
# Les erreurs graphiques {background-color="black" background-position="center"}

# Les erreurs de systèmes de mesures {background-color="black" background-position="center"}

# Les erreurs par omission {background-color="black" background-position="center"}

##  {background-image="https://www.cs.cornell.edu/~hweather/FaultTolerance/HW1/y2k_checklist.gif" background-size="contain"}

# Les erreurs de débordement {.center}
